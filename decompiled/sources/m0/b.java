...
public final class b {
    ...
    private static p f2406c0 = new p(0.0f, 0.0f, 1.0f, 1.0f);
    ...
    private static q f2410g0 = new q(0.0f, 0.0f);

    /* JADX INFO: renamed from: h0, reason: collision with root package name */
    private static q f2411h0 = new q(0.0f, 0.0f);

    /* JADX INFO: renamed from: i0, reason: collision with root package name */
    private static b f2412i0;

    /* JADX INFO: renamed from: j0, reason: collision with root package name */
    private static q f2413j0;
    ...
    private com.badlogic.gdx.utils.a<Coords> f2436v;
    ...
    public static p U() {
        ...
        return new p(i2, i3, i6 - i2, i7 - i3);
    }
    ...
    public static boolean Z(Character character, Character character2) {
        if (!character.i0() && !character.destroy && !character2.i0() && !character2.destroy) {
            ...
            p pVar = new p(coords.f3287x - 16, coords.f3288y - 16, 32.0f, 32.0f);
            p pVarS = character.S(false);
            int i2 = i.f68h;
    ...
    public static ArrayList j(p pVar) {
        ArrayList arrayList = new ArrayList();
        for (MapActor mapActor : GameLevel.f3096c) {
            if (mapActor.S(false) != null) {
                p pVarS = mapActor.S(false);
                int i2 = i.f68h;
                if (pVar.overlaps(pVarS)) {
                    arrayList.add(Integer.valueOf(mapActor.q()));
                }
    ...
    public static int n(int[] iArr, p pVar) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (arrayList.get(i2).S(false) != null) {
                p pVarS = arrayList.get(i2).S(false);
                int i3 = i.f68h;
    ...
    public final ArrayList<Bed> G(p pVar) {
    ...
    public final ArrayList<MapContainer> I(p pVar) {
    ...
    public final com.badlogic.gdx.utils.a<Coords> T(int i2, int i3) {
    ...
    public final ArrayList<MapCastle> f0(p pVar) {
    ...
    public final ArrayList<RestPoint> h0(p pVar) {
    ...
    */
                ...
                for (int i7 = i5 - 1; i7 <= i5 + 1; i7++) {
                    if (i6 >= 0 && i6 < this.f2417b && i7 >= 0 && i7 < this.f2418c) {
                        ...
                        if (arrayList2.get(i3).S(true) != null) {
                            p pVarS = arrayList2.get(i3).S(true);
                            int i8 = i.f68h;
                            if (pVar.overlaps(pVarS)) {
                                this.s[i6][i7] = 1;
                            }
    ...
    public final void w(String str) {
        ...
        int iIntValue = ((Integer) this.M.c("height")).intValue();
        ...
        if (this.M.a("maxlight")) {
            this.f2424i = Integer.parseInt(this.M.b("maxlight").toString());
        } else {
            this.f2424i = 0;
        }
        if (this.M.a("music")) {
            this.f2415a = this.M.b("music").toString();
        } else {
            this.f2415a = "";
        }
        if (this.M.a("nominimap")) {
            this.f2425j = true;
        } else {
            this.f2425j = false;
        }
        ...
        if (this.M.a("norecall")) {
            this.f2427l = true;
        } else {
            this.f2427l = false;
        }
        if (this.M.a("faction_civilian")) {
            this.E = this.M.b("faction_civilian").toString();
        } else {
            this.E = "";
        }
        if (this.M.a("faction_guard")) {
            this.F = this.M.b("faction_guard").toString();
        } else {
            this.F = "";
        }
        if (this.M.a("faction_trap")) {
            this.G = this.M.b("faction_trap").toString();
        } else {
            this.G = "";
        }
        boolean zA = this.M.a("exit_s");
        Transition transition = this.N;
        if (zA) {
            transition.area_id = this.M.b("exit_s").toString();
        } else {
            transition.area_id = "";
        }
        boolean zA2 = this.M.a("exit_n");
        Transition transition2 = this.O;
        if (zA2) {
            transition2.area_id = this.M.b("exit_n").toString();
        } else {
            transition2.area_id = "";
        }
        boolean zA3 = this.M.a("exit_e");
        Transition transition3 = this.P;
        if (zA3) {
            transition3.area_id = this.M.b("exit_e").toString();
        } else {
            transition3.area_id = "";
        }
        boolean zA4 = this.M.a("exit_w");
        Transition transition4 = this.Q;
        if (zA4) {
            transition4.area_id = this.M.b("exit_w").toString();
        } else {
            transition4.area_id = "";
        }
