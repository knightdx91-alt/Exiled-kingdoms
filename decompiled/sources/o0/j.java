...
public final class j extends Table {
    ...
    public final void c(int i2) {
        ...
        if (i2 > 0) {
            ...
            CharacterResistances.ResistanceType resistanceType = CharacterResistances.ResistanceType.f2995a;
            ...
            CharacterResistances.ResistanceType resistanceType2 = CharacterResistances.ResistanceType.f2996b;
            ...
            CharacterResistances.ResistanceType resistanceType3 = CharacterResistances.ResistanceType.f2997c;
            ...
            CharacterResistances.ResistanceType resistanceType4 = CharacterResistances.ResistanceType.f2998d;
            ...
            CharacterResistances.ResistanceType resistanceType5 = CharacterResistances.ResistanceType.f2999e;
            ...
            CharacterResistances.ResistanceType resistanceType6 = CharacterResistances.ResistanceType.f3000f;
            ...
            add(table).left();
            if (Rules.f(i2).type == Item.ItemType.f3230b) {
