...
public final class f extends Window {
    ...
    public void M(int i2) {
        int iR = R();
        int i3 = 1;
        if (K0.getType() == Lootable.LootableType.f3066c) {
    ...
    public final void B() {
        ...
        int i4 = V0;
        Item.ItemType itemType = Item.ItemType.f3242n;
        Item.ItemType itemType2 = Item.ItemType.f3243o;
        Item.ItemType itemType3 = Item.ItemType.f3231c;
        Item.ItemType itemType4 = Item.ItemType.f3241m;
        Item.ItemType itemType5 = Item.ItemType.f3240l;
        Item.ItemType itemType6 = Item.ItemType.f3235g;
        Item.ItemType itemType7 = Item.ItemType.f3232d;
        Item.ItemType itemType8 = Item.ItemType.f3234f;
        Item.ItemType itemType9 = Item.ItemType.f3233e;
        Item.ItemType itemType10 = Item.ItemType.f3236h;
        Item.ItemType itemType11 = Item.ItemType.f3230b;
        if (i4 == 1 && (itemF = Rules.f(R())) != null) {
            ...
            if (itemF.g(this.f3498o.sheet)) {
                ...
                if (itemF.type == Item.ItemType.f3237i) {
                    GameAssets.o("potion");
                } else {
                    GameAssets.o("buff1");
                }
    ...
    */
    public final void U(int i2, Lootable lootable, Character character) {
        ...
        if (i4 == 0) {
            ...
            if (lootable != null) {
                ...
                K0 = lootable;
                M0 = lootable.a();
                if (K0.getType() == Lootable.LootableType.f3066c || K0.g()) {
                    z2 = 0;
    ...
    public final void X() {
        ...
        if (zIsVisible) {
            ...
            int i3 = V0;
            Lootable.LootableType lootableType = Lootable.LootableType.f3066c;
            if (i3 == 0 || R() == 0) {
            ...
            if (L0 == 0) {
                ...
                this.D.setText(Q(characterSheet.F(CharacterResistances.ResistanceType.f2995a)));
                this.E.setText(Q(characterSheet.F(CharacterResistances.ResistanceType.f2996b)));
                this.F.setText(Q(characterSheet.F(CharacterResistances.ResistanceType.f2997c)));
                this.G.setText(Q(characterSheet.F(CharacterResistances.ResistanceType.f2998d)));
                this.H.setText(Q(characterSheet.F(CharacterResistances.ResistanceType.f2999e)));
                this.I.setText(Q(characterSheet.F(CharacterResistances.ResistanceType.f3000f)));
