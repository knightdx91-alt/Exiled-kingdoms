...
public final class c1 extends Window {
    ...
    public c1() {
        ...
        b1 b1Var = new b1(b1.c.f2552e, this);
        b1 b1Var2 = new b1(b1.c.f2569w, this);
        b1 b1Var3 = new b1(b1.c.f2561n, this);
        b1 b1Var4 = new b1(b1.c.f2566t, this);
        b1 b1Var5 = new b1(b1.c.f2567u, this);
        b1 b1Var6 = new b1(b1.c.f2568v, this);
        b1 b1Var7 = new b1(b1.c.f2570x, this);
        b1 b1Var8 = new b1(b1.c.f2572z, this);
        b1 b1Var9 = new b1(b1.c.f2571y, this);
        b1 b1Var10 = new b1(b1.c.f2548a, this);
        b1 b1Var11 = new b1(b1.c.f2549b, this);
        b1 b1Var12 = new b1(b1.c.f2550c, this);
        b1 b1Var13 = new b1(b1.c.f2551d, this);
        b1 b1Var14 = new b1(b1.c.f2553f, this);
        b1 b1Var15 = new b1(b1.c.f2554g, this);
        b1 b1Var16 = new b1(b1.c.f2555h, this);
        b1 b1Var17 = new b1(b1.c.f2556i, this);
        b1 b1Var18 = new b1(b1.c.f2557j, this);
        b1 b1Var19 = new b1(b1.c.f2558k, this);
        b1 b1Var20 = new b1(b1.c.f2559l, this);
        b1 b1Var21 = new b1(b1.c.f2560m, this);
        b1 b1Var22 = new b1(b1.c.f2562o, this);
        b1 b1Var23 = new b1(b1.c.f2563p, this);
        b1 b1Var24 = new b1(b1.c.f2564q, this);
        b1 b1Var25 = new b1(b1.c.f2565r, this);
    ...
    public final void draw(Batch batch, float f2) {
        ...
        if (i2 != -999) {
            ...
            controllerCommand.type = ControllerCommand.commandType.f3368d;
