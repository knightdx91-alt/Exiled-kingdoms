...
public final class b implements n, j {
    ...
    private static com.badlogic.gdx.e f2316q;
    ...
    public b(com.badlogic.gdx.e eVar, Transition transition) {
        this.f2325h = 0.5f;
        f2316q = eVar;
        l.d("GameScreen constructor called t.area=" + transition.area_id);
        i iVar = new i();
        if (ExiledKingdoms.f3378h) {
            iVar.a(new com.badlogic.gdx.input.a(z.v().t()));
        }
        iVar.a(z.v().a());
        iVar.a(this);
    ...
    */
    private static void d(Transition transition) {
        ...
        assets.u();
        com.badlogic.gdx.utils.a<AnimationSet> aVar = AnimationLoader.f3300a;
        if (aVar != null) {
        ...
        GameData.GameStatus gameStatus = GameData.GameStatus.f3184a;
        if (z2) {
        ...
        if (GameData.v().party != null && GameData.v().party.j()) {
            ...
            if (Player.f3027e && npcF.sheet.o() == 0) {
                npcF.q0(MapActor.ActorState.f3074d);
                npcF.o("RECOVER", npcF.q(), null, 1.0f, null);
            } else {
                npcF.q0(MapActor.ActorState.f3071a);
            }
    ...
    public static void e() {
        com.badlogic.gdx.e eVar = f2316q;
        if (eVar != null) {
    ...
    private void k(float f2, float f3) {
        if (this.f2324g == null) {
            this.f2324g = new q(0.0f, 0.0f);
        }
        if (this.f2323f == null) {
            this.f2323f = new q(0.0f, 0.0f);
        }
        if (this.f2322e == null) {
            this.f2322e = new q(0.0f, 0.0f);
        }
