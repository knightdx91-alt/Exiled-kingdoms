...
public class Cell<T extends Actor> implements c0.a {
    ...
    public Cell() {
        Cell cellDefaults = defaults();
        if (cellDefaults != null) {
            set(cellDefaults);
        }
    }
    ...
    public float getPadX() {
        return this.padRight.get(this.actor) + this.padLeft.get(this.actor);
    }

    public float getPadY() {
        return this.padBottom.get(this.actor) + this.padTop.get(this.actor);
    }
    ...
    public Cell<T> expand(int i2, int i3) {
        this.expandX = Integer.valueOf(i2);
        this.expandY = Integer.valueOf(i3);
        return this;
    }
    ...
    public Cell<T> uniform(boolean z2) {
        this.uniformX = Boolean.valueOf(z2);
    ...
    public Cell<T> expand(boolean z2, boolean z3) {
        this.expandX = z2 ? onei : zeroi;
        this.expandY = z3 ? onei : zeroi;
        return this;
    }

    public Cell<T> fill(boolean z2, boolean z3) {
        this.fillX = z2 ? onef : zerof;
