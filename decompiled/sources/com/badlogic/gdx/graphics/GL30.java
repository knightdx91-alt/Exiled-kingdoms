...
public interface GL30 extends GL20 {
    ...
    void glBeginQuery(int i2, int i3);

    void glBeginTransformFeedback(int i2);

    void glBindBufferBase(int i2, int i3, int i4);

    void glBindBufferRange(int i2, int i3, int i4, int i5, int i6);

    void glBindSampler(int i2, int i3);

    void glBindTransformFeedback(int i2, int i3);

    void glBindVertexArray(int i2);

    void glBlitFramebuffer(int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11);

    void glClearBufferfi(int i2, int i3, float f2, int i4);

    void glClearBufferfv(int i2, int i3, FloatBuffer floatBuffer);

    void glClearBufferiv(int i2, int i3, IntBuffer intBuffer);

    void glClearBufferuiv(int i2, int i3, IntBuffer intBuffer);

    void glCopyBufferSubData(int i2, int i3, int i4, int i5, int i6);

    void glCopyTexSubImage3D(int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10);

    void glDeleteQueries(int i2, IntBuffer intBuffer);

    void glDeleteQueries(int i2, int[] iArr, int i3);

    void glDeleteSamplers(int i2, IntBuffer intBuffer);

    void glDeleteSamplers(int i2, int[] iArr, int i3);

    void glDeleteTransformFeedbacks(int i2, IntBuffer intBuffer);

    void glDeleteTransformFeedbacks(int i2, int[] iArr, int i3);

    void glDeleteVertexArrays(int i2, IntBuffer intBuffer);

    void glDeleteVertexArrays(int i2, int[] iArr, int i3);

    void glDrawArraysInstanced(int i2, int i3, int i4, int i5);

    void glDrawBuffers(int i2, IntBuffer intBuffer);

    void glDrawElementsInstanced(int i2, int i3, int i4, int i5, int i6);

    void glDrawRangeElements(int i2, int i3, int i4, int i5, int i6, int i7);

    void glDrawRangeElements(int i2, int i3, int i4, int i5, int i6, Buffer buffer);

    void glEndQuery(int i2);

    void glEndTransformFeedback();

    void glFlushMappedBufferRange(int i2, int i3, int i4);

    void glFramebufferTextureLayer(int i2, int i3, int i4, int i5, int i6);

    void glGenQueries(int i2, IntBuffer intBuffer);

    void glGenQueries(int i2, int[] iArr, int i3);

    void glGenSamplers(int i2, IntBuffer intBuffer);

    void glGenSamplers(int i2, int[] iArr, int i3);

    void glGenTransformFeedbacks(int i2, IntBuffer intBuffer);

    void glGenTransformFeedbacks(int i2, int[] iArr, int i3);

    void glGenVertexArrays(int i2, IntBuffer intBuffer);

    void glGenVertexArrays(int i2, int[] iArr, int i3);

    String glGetActiveUniformBlockName(int i2, int i3);

    void glGetActiveUniformBlockName(int i2, int i3, Buffer buffer, Buffer buffer2);

    void glGetActiveUniformBlockiv(int i2, int i3, int i4, IntBuffer intBuffer);

    void glGetActiveUniformsiv(int i2, int i3, IntBuffer intBuffer, int i4, IntBuffer intBuffer2);

    void glGetBufferParameteri64v(int i2, int i3, LongBuffer longBuffer);

    Buffer glGetBufferPointerv(int i2, int i3);

    int glGetFragDataLocation(int i2, String str);

    void glGetInteger64v(int i2, LongBuffer longBuffer);

    void glGetQueryObjectuiv(int i2, int i3, IntBuffer intBuffer);

    void glGetQueryiv(int i2, int i3, IntBuffer intBuffer);

    void glGetSamplerParameterfv(int i2, int i3, FloatBuffer floatBuffer);

    void glGetSamplerParameteriv(int i2, int i3, IntBuffer intBuffer);

    String glGetStringi(int i2, int i3);

    int glGetUniformBlockIndex(int i2, String str);

    void glGetUniformIndices(int i2, String[] strArr, IntBuffer intBuffer);

    void glGetUniformuiv(int i2, int i3, IntBuffer intBuffer);

    void glGetVertexAttribIiv(int i2, int i3, IntBuffer intBuffer);

    void glGetVertexAttribIuiv(int i2, int i3, IntBuffer intBuffer);

    void glInvalidateFramebuffer(int i2, int i3, IntBuffer intBuffer);

    void glInvalidateSubFramebuffer(int i2, int i3, IntBuffer intBuffer, int i4, int i5, int i6, int i7);

    boolean glIsQuery(int i2);

    boolean glIsSampler(int i2);

    boolean glIsTransformFeedback(int i2);

    boolean glIsVertexArray(int i2);

    void glPauseTransformFeedback();

    void glProgramParameteri(int i2, int i3, int i4);

    void glReadBuffer(int i2);

    void glRenderbufferStorageMultisample(int i2, int i3, int i4, int i5, int i6);

    void glResumeTransformFeedback();

    void glSamplerParameterf(int i2, int i3, float f2);

    void glSamplerParameterfv(int i2, int i3, FloatBuffer floatBuffer);

    void glSamplerParameteri(int i2, int i3, int i4);

    void glSamplerParameteriv(int i2, int i3, IntBuffer intBuffer);

    void glTexImage3D(int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11);

    void glTexImage3D(int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, Buffer buffer);

    void glTexSubImage3D(int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12);

    void glTexSubImage3D(int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, Buffer buffer);

    void glTransformFeedbackVaryings(int i2, String[] strArr, int i3);

    void glUniform1uiv(int i2, int i3, IntBuffer intBuffer);

    void glUniform3uiv(int i2, int i3, IntBuffer intBuffer);

    void glUniform4uiv(int i2, int i3, IntBuffer intBuffer);

    void glUniformBlockBinding(int i2, int i3, int i4);

    void glUniformMatrix2x3fv(int i2, int i3, boolean z2, FloatBuffer floatBuffer);

    void glUniformMatrix2x4fv(int i2, int i3, boolean z2, FloatBuffer floatBuffer);

    void glUniformMatrix3x2fv(int i2, int i3, boolean z2, FloatBuffer floatBuffer);

    void glUniformMatrix3x4fv(int i2, int i3, boolean z2, FloatBuffer floatBuffer);

    void glUniformMatrix4x2fv(int i2, int i3, boolean z2, FloatBuffer floatBuffer);

    void glUniformMatrix4x3fv(int i2, int i3, boolean z2, FloatBuffer floatBuffer);

    boolean glUnmapBuffer(int i2);

    void glVertexAttribDivisor(int i2, int i3);

    void glVertexAttribI4i(int i2, int i3, int i4, int i5, int i6);

    void glVertexAttribI4ui(int i2, int i3, int i4, int i5, int i6);

    void glVertexAttribIPointer(int i2, int i3, int i4, int i5, int i6);
