...
public interface GL20 {
    ...
    String glGetActiveAttrib(int i2, int i3, IntBuffer intBuffer, IntBuffer intBuffer2);

    String glGetActiveUniform(int i2, int i3, IntBuffer intBuffer, IntBuffer intBuffer2);
