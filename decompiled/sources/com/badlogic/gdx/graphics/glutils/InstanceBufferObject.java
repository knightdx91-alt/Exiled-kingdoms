...
public class InstanceBufferObject implements InstanceData {
    ...
    public InstanceBufferObject(boolean z2, int i2, VertexAttribute... vertexAttributeArr) {
    ...
    public InstanceBufferObject(boolean z2, int i2, VertexAttributes vertexAttributes) {
        this.isDirty = false;
        this.isBound = false;
        if (Gdx.gl30 == null) {
            throw new m("InstanceBufferObject requires a device running with GLES 3.0 compatibilty");
        }
        this.bufferHandle = Gdx.gl20.glGenBuffer();
    ...
    public void unbind(ShaderProgram shaderProgram, int[] iArr) {
        ...
        if (iArr == null) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                int i4 = iArr[i3];
                if (i4 >= 0) {
                    shaderProgram.disableVertexAttribute(i4 + vertexAttribute2.unit);
                }
            }
        }
        gl20.glBindBuffer(GL20.GL_ARRAY_BUFFER, 0);
