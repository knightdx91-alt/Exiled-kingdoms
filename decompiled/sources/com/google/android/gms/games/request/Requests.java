...
public interface Requests {
    ...
    public interface LoadRequestsResult extends Releasable, Result {
        GameRequestBuffer getRequests(int i2);
    }
    ...
    Intent getSendIntent(GoogleApiClient googleApiClient, int i2, byte[] bArr, int i3, Bitmap bitmap, String str);

    PendingResult<LoadRequestsResult> loadRequests(GoogleApiClient googleApiClient, int i2, int i3, int i4);
