...
public interface Snapshots {
    ...
    Intent getSelectSnapshotIntent(GoogleApiClient googleApiClient, String str, boolean z2, boolean z3, int i2);

    SnapshotMetadata getSnapshotFromBundle(Bundle bundle);

    PendingResult<LoadSnapshotsResult> load(GoogleApiClient googleApiClient, boolean z2);

    PendingResult<OpenSnapshotResult> open(GoogleApiClient googleApiClient, SnapshotMetadata snapshotMetadata);

    PendingResult<OpenSnapshotResult> open(GoogleApiClient googleApiClient, SnapshotMetadata snapshotMetadata, int i2);

    PendingResult<OpenSnapshotResult> open(GoogleApiClient googleApiClient, String str, boolean z2);

    PendingResult<OpenSnapshotResult> open(GoogleApiClient googleApiClient, String str, boolean z2, int i2);
