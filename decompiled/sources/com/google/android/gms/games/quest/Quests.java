...
public interface Quests {
    ...
    PendingResult<LoadQuestsResult> load(GoogleApiClient googleApiClient, int[] iArr, int i2, boolean z2);

    PendingResult<LoadQuestsResult> loadByIds(GoogleApiClient googleApiClient, boolean z2, String... strArr);
