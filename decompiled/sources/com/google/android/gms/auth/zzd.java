...
public class zzd {
    ...
    public static List<AccountChangeEvent> getAccountChangeEvents(Context context, int i2, String str) throws GoogleAuthException {
    ...
    public static <T> T zza(T t2) throws IOException {
        if (t2 != null) {
            return t2;
        }
