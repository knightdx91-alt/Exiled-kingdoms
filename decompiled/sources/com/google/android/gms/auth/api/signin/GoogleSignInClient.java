...
public class GoogleSignInClient extends GoogleApi<GoogleSignInOptions> {
    ...
    public Intent getSignInIntent() {
        Context applicationContext = getApplicationContext();
        int i2 = com.google.android.gms.auth.api.signin.zzc.zzat[zze() - 1];
        return i2 != 1 ? i2 != 2 ? zzh.zze(applicationContext, getApiOptions()) : zzh.zzc(applicationContext, getApiOptions()) : zzh.zzd(applicationContext, getApiOptions());
    }
