...
public final class HintRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static final class Builder {
        ...
        public final Builder setEmailAddressIdentifierSupported(boolean z2) {
            this.zzai = z2;
            return this;
        }
        ...
        public final Builder setIdTokenRequested(boolean z2) {
            this.zzad = z2;
            return this;
        }

        public final Builder setPhoneNumberIdentifierSupported(boolean z2) {
            this.zzaj = z2;
            return this;
        }
    ...
    HintRequest(@SafeParcelable.Param(id = CredentialsApi.ACTIVITY_RESULT_ADD_ACCOUNT) int i2, @SafeParcelable.Param(id = 1) CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(id = 2) boolean z2, @SafeParcelable.Param(id = 3) boolean z3, @SafeParcelable.Param(id = 4) String[] strArr, @SafeParcelable.Param(id = 5) boolean z4, @SafeParcelable.Param(id = 6) String str, @SafeParcelable.Param(id = 7) String str2) {
        this.zzu = i2;
        this.zzah = (CredentialPickerConfig) Preconditions.checkNotNull(credentialPickerConfig);
        this.zzai = z2;
        this.zzaj = z3;
