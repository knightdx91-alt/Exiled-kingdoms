...
public class ProxyRequest extends AbstractSafeParcelable {
    ...
    ProxyRequest(@SafeParcelable.Param(id = CredentialsApi.ACTIVITY_RESULT_ADD_ACCOUNT) int i2, @SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) int i3, @SafeParcelable.Param(id = 3) long j2, @SafeParcelable.Param(id = 4) byte[] bArr, @SafeParcelable.Param(id = 5) Bundle bundle) {
        this.versionCode = i2;
        this.url = str;
        this.httpMethod = i3;
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder(a.e(42, str));
