...
public class PackageManagerWrapper {
    ...
    public ApplicationInfo getApplicationInfo(String str, int i2) {
        return this.zzhv.getPackageManager().getApplicationInfo(str, i2);
    }
    ...
    public PackageInfo getPackageInfo(String str, int i2) {
        return this.zzhv.getPackageManager().getPackageInfo(str, i2);
    }

    public final String[] getPackagesForUid(int i2) {
        return this.zzhv.getPackageManager().getPackagesForUid(i2);
    }
    ...
    public final PackageInfo zza(String str, int i2, int i3) {
    ...
    public final boolean zzb(int i2, String str) {
        if (PlatformVersion.isAtLeastKitKat()) {
            try {
                ((AppOpsManager) this.zzhv.getSystemService("appops")).checkPackage(i2, str);
                return true;
            } catch (SecurityException unused) {
                return false;
            }
        }
        String[] packagesForUid = this.zzhv.getPackageManager().getPackagesForUid(i2);
