...
public final class ConnectionErrorMessages {
    private static final i<String, String> zaof = new i<>();
    ...
    public static String getErrorDialogButtonMessage(Context context, int i2) {
        ...
        return i2 != 1 ? i2 != 2 ? i2 != 3 ? resources.getString(android.R.string.ok) : resources.getString(R.string.common_google_play_services_enable_button) : resources.getString(R.string.common_google_play_services_update_button) : resources.getString(R.string.common_google_play_services_install_button);
    }
    ...
    public static String getErrorNotificationMessage(Context context, int i2) {
        return i2 == 6 ? zaa(context, "common_google_play_services_resolution_required_text", getAppName(context)) : getErrorMessage(context, i2);
    }

    public static String getErrorNotificationTitle(Context context, int i2) {
        String strZaa = i2 == 6 ? zaa(context, "common_google_play_services_resolution_required_title") : getErrorTitle(context, i2);
