...
public class SafeParcelReader {
    ...
    public static class ParseException extends RuntimeException {
        public ParseException(String str, Parcel parcel) {
            ...
            StringBuilder sb = new StringBuilder(a.e(41, str));
            sb.append(str);
    ...
    public static void ensureAtEnd(Parcel parcel, int i2) {
        if (parcel.dataPosition() != i2) {
            throw new ParseException(a.g(37, i2, "Overread allowed size end="), parcel);
        }
    }
    ...
    private static void zza(Parcel parcel, int i2, int i3) {
        ...
        StringBuilder sb = new StringBuilder(a.e(46, hexString));
