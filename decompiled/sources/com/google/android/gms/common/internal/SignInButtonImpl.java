...
public final class SignInButtonImpl extends Button {
    ...
    private static int zaa(int i2, int i3, int i4, int i5) {
        ...
        throw new IllegalStateException(a.g(33, i2, "Unknown color scheme: "));
    }
    ...
    public final void configure(Resources resources, int i2, int i3) {
        ...
        if (i2 == 0 || i2 == 1) {
            ...
            throw new IllegalStateException(a.g(32, i2, "Unknown button size: "));
        }
        Drawable drawable = resources.getDrawable(iZaa);
