...
final class zzc {
    ...
    private static zzm zzb(final String str, final zze zzeVar, final boolean z2) {
        try {
            if (zzn == null) {
            ...
            Preconditions.checkNotNull(zzp);
            try {
                return zzn.zza(new zzk(str, zzeVar, z2), ObjectWrapper.wrap(zzp.getPackageManager())) ? zzm.zze() : zzm.zza(new Callable(z2, str, zzeVar) { // from class: com.google.android.gms.common.zzd
    ...
    static zzm zza(String str, zze zzeVar, boolean z2) {
        StrictMode.ThreadPolicy threadPolicyAllowThreadDiskReads = StrictMode.allowThreadDiskReads();
        try {
            return zzb(str, zzeVar, z2);
        } finally {
    ...
    */
    static final /* synthetic */ String zza(boolean z2, String str, zze zzeVar) {
        boolean z3;
        if (!z2) {
            z3 = zzb(str, zzeVar, true).zzac;
        }
        return zzm.zza(str, zzeVar, z2, z3);
    }
}
