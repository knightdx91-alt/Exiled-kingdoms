...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    DataHolder(@SafeParcelable.Param(id = CredentialsApi.ACTIVITY_RESULT_ADD_ACCOUNT) int i2, @SafeParcelable.Param(id = 1) String[] strArr, @SafeParcelable.Param(id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(id = 3) int i3, @SafeParcelable.Param(id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalw = true;
        this.zale = i2;
        this.zalp = strArr;
    ...
    public static DataHolder empty(int i2) {
        return new DataHolder(zalx, i2, (Bundle) null);
    }
    ...
    public final boolean getBoolean(String str, int i2, int i3) {
        zaa(str, i2);
        return this.zalr[i3].getLong(i2, this.zalq.getInt(str)) == 1;
    }

    @KeepForSdk
    public final byte[] getByteArray(String str, int i2, int i3) {
        zaa(str, i2);
        return this.zalr[i3].getBlob(i2, this.zalq.getInt(str));
    }
    ...
    public final int getInteger(String str, int i2, int i3) {
        zaa(str, i2);
        return this.zalr[i3].getInt(i2, this.zalq.getInt(str));
    }

    @KeepForSdk
    public final long getLong(String str, int i2, int i3) {
        zaa(str, i2);
        return this.zalr[i3].getLong(i2, this.zalq.getInt(str));
    }
    ...
    public final String getString(String str, int i2, int i3) {
        zaa(str, i2);
        return this.zalr[i3].getString(i2, this.zalq.getInt(str));
    }
    ...
    public final int getWindowIndex(int i2) {
        int[] iArr;
        int i3 = 0;
        Preconditions.checkState(i2 >= 0 && i2 < this.zalv);
        while (true) {
            iArr = this.zalu;
            if (i3 >= iArr.length) {
                break;
    ...
    public final boolean hasNull(String str, int i2, int i3) {
        zaa(str, i2);
        return this.zalr[i3].isNull(i2, this.zalq.getInt(str));
    }
    ...
    public final void writeToParcel(Parcel parcel, int i2) {
        ...
        SafeParcelWriter.writeTypedArray(parcel, 2, this.zalr, i2, false);
        SafeParcelWriter.writeInt(parcel, 3, getStatusCode());
        SafeParcelWriter.writeBundle(parcel, 4, getMetadata(), false);
        SafeParcelWriter.writeInt(parcel, CredentialsApi.ACTIVITY_RESULT_ADD_ACCOUNT, this.zale);
    ...
    public final double zab(String str, int i2, int i3) {
        zaa(str, i2);
        return this.zalr[i3].getDouble(i2, this.zalq.getInt(str));
    }
    ...
    public final void zaca() {
        ...
        while (true) {
            ...
            numRows += this.zalr[i2].getNumRows() - (numRows - cursorWindowArr[i2].getStartPosition());
            i2++;
        }
    }
    ...
    private DataHolder(Builder builder, int i2, Bundle bundle) {
        this(builder.zalp, zaa(builder, -1), i2, (Bundle) null);
    }

    private DataHolder(Builder builder, int i2, Bundle bundle, int i3) {
        this(builder.zalp, zaa(builder, -1), i2, bundle);
    }
    ...
    private static CursorWindow[] zaa(Builder builder, int i2) {
        if (builder.zalp.length != 0) {
            List listSubList = (i2 < 0 || i2 >= builder.zaly.size()) ? builder.zaly : builder.zaly.subList(0, i2);
    ...
    private final void zaa(String str, int i2) {
        ...
        if (bundle != null && bundle.containsKey(str)) {
            if (!isClosed()) {
                if (i2 < 0 || i2 >= this.zalv) {
                    throw new CursorIndexOutOfBoundsException(i2, this.zalv);
                }
                return;
            }
    ...
    public final float zaa(String str, int i2, int i3) {
        zaa(str, i2);
        return this.zalr[i3].getFloat(i2, this.zalq.getInt(str));
    }

    public final void zaa(String str, int i2, int i3, CharArrayBuffer charArrayBuffer) {
        zaa(str, i2);
        this.zalr[i3].copyStringToBuffer(i2, this.zalq.getInt(str), charArrayBuffer);
    }
}
