...
public final class CollectionUtils {
    ...
    private static <T> Set<T> zza(int i2, boolean z2) {
        return i2 <= (z2 ? VertexAttributes.Usage.Tangent : 256) ? new c(i2) : new HashSet(i2, z2 ? 0.75f : 1.0f);
    }

    private static <K, V> Map<K, V> zzb(int i2, boolean z2) {
        return i2 <= 256 ? new b(i2) : new HashMap(i2, 1.0f);
    }
