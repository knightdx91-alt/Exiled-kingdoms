...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int i2, Activity activity, Fragment fragment, int i3, DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog dialogZaa = GoogleApiAvailability.zaa(activity, i2, DialogRedirect.getInstance(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i2, "d"), i3), onCancelListener);
        if (dialogZaa == null) {
            return false;
        }
