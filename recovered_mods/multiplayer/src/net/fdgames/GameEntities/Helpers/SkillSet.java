...
public class SkillSet {
    ...
    public final void n() {
        ...
        for (CharacterSkill characterSkill : this.characterSkills) {
            ...
            if (characterSkill.skillID.equals(jzidqMPaLNVH.xASUs)) {
            ...
            if (characterSkill.skillID.equals(KOdB.vtihqCxqoIect)) {
    ...
    public final void p() {
        for (CharacterSkill characterSkill : this.characterSkills) {
            if (Skills.c(characterSkill.skillID).type == Skill.SKILL_TYPE.f3498b) {
                characterSkill.timeToCoolDown = 0.0f;
            }
        }
    }
    ...
    public final void t(float f2) {
        ...
        for (int i2 = 0; i2 < this.characterSkills.size(); i2++) {
            if (this.characterSkills.get(i2).skillID != null && (skillC = Skills.c(this.characterSkills.get(i2).skillID)) != null && skillC.type == Skill.SKILL_TYPE.f3498b) {
    ...
    public final String toString() {
        ...
        for (CharacterSkill characterSkill : this.characterSkills) {
            if (characterSkill.level > 0) {
                ...
                sbR.append(characterSkill.skillID);
                sbR.append("=");
                strP = a.p(sbR, characterSkill.level, ",");
            }
        }
