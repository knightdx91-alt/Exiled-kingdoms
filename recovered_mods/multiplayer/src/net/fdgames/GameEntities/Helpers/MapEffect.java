...
public class MapEffect {
    ...
    public MapEffect(String str, int i2, int i3, int i4, boolean z2) {
        ...
        MapEffectData.MapEffectDataLine mapEffectDataLineA = Rules.f3478k.a(str);
        ...
        int i5 = 0;
        while (true) {
            if (i5 >= GameAssets.f3569r) {
                i5 = 0;
                break;
            } else if (GameAssets.f3571s[i5].name.equals(strO)) {
                break;
            } else {
                i5++;
            }
        ...
        int i8 = i7 / 2;
        float f2 = i7;
        this.collisionRectangle = new p(i6 - i8, this.f3284y - i8, f2, f2);
    ...
    public final int a() {
        return (this.f3283x + this.f3284y) - 35;
    }

    public final int b() {
        return (this.f3284y - this.f3283x) / 2;
    }

    public final TextureRegion c() {
        this.drawn = true;
        return (TextureRegion) GameAssets.f3571s[this.animationIndex].animation.getKeyFrame(this.stateRelativeTime);
    }

    public final void d() {
        int i2 = this.f3283x;
        if (i2 / 32 <= 0 || this.f3284y / 32 <= 0 || i2 / 32 >= b.P().f4029u.length || this.f3284y / 32 >= b.P().f4029u[0].length) {
            return;
        }
        b.P().f4029u[this.f3283x / 32][this.f3284y / 32] = 1;
    }
    ...
    public final void f() {
        ...
        b.P().f4029u[this.f3283x / 32][this.f3284y / 32] = 0;
    }
                ...
                if (characterF != null) {
                    ...
                    if (this.effect.contains("deathcloud")) {
                        if (characterF.s()) {
                            ...
                            CharacterResistances.ResistanceType resistanceType = CharacterResistances.ResistanceType.f3213e;
                            if (zEquals) {
                    ...
                    if (this.effect.contains("combustion")) {
                        if (characterF.s()) {
                            ...
                            characterF.q1(CharacterResistances.ResistanceType.f3210b, i3, 15.0f);
                            characterF.q1(CharacterResistances.ResistanceType.f3211c, i3, 15.0f);
                            characterF.q1(CharacterResistances.ResistanceType.f3212d, i3, 15.0f);
