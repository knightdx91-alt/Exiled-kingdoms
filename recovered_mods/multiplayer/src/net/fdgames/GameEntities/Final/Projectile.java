...
public class Projectile extends MapSprite {
    ...
    public static final class ProjectileType {
        ...
        public static final ProjectileType f3245b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        public static final ProjectileType f3246c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        public static final ProjectileType f3247d;

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ ProjectileType[] f3248e;

        static {
            ProjectileType projectileType = new ProjectileType("ARROW", 0);
            f3245b = projectileType;
            ProjectileType projectileType2 = new ProjectileType("BOLT", 1);
            f3246c = projectileType2;
            ProjectileType projectileType3 = new ProjectileType("GRENADE", 2);
            f3247d = projectileType3;
            f3248e = new ProjectileType[]{projectileType, projectileType2, projectileType3};
        }
        ...
        public static ProjectileType[] values() {
            return (ProjectileType[]) f3248e.clone();
        }
    }
    ...
    public Projectile(int i2, int i3, int i4, int[] iArr, WeaponStats weaponStats, DamageData damageData, ProjectileType projectileType) {
        ...
        this.owner_id = i2;
        this.f3307x = GameLevel.i(i2).f3307x;
        this.f3308y = GameLevel.i(this.owner_id).f3308y;
        ...
        qVar.a();
        float f4 = qVar.f3178b;
        float f5 = weaponStats.ranged_speed;
        this.speedX = f4 * f5;
        float f6 = qVar.f3179c;
        this.speedY = f5 * f6;
        float fAtan2 = ((float) Math.atan2(f6, f4)) * 57.295776f;
        this.angle = fAtan2 < 0.0f ? fAtan2 + 360.0f : fAtan2;
        if (weaponStats.id.equals("firedancer_shot") || weaponStats.id.contains(lRWXeT.ymDYnwQRGgOInH) || weaponStats.id.contains("lightning") || this.sprite.equals("ion") || weaponStats.id.contains("wand") || weaponStats.id.contains("staff")) {
    ...
    public final void F(SpriteBatch spriteBatch) {
        ...
        GameAssets.f3536a.a(Assets.o(this.sprite));
    ...
    public final void M(float f2) {
        ...
        ProjectileType projectileType = ProjectileType.f3247d;
        if (i2 == 1 && GameData.v().u() > this.creationTime + 0.45f) {
            this.destroy = true;
            if (this.type == projectileType) {
                AreaEffects.d(this.f3307x, this.f3308y, 1, this.explosionID);
            }
        }
        float f3 = this.speedX;
        if (f3 != 0.0f) {
            this.f3307x = Math.round(this.f3307x + (f3 * f2));
        }
        float f4 = this.speedY;
        if (f4 != 0.0f) {
            this.f3308y = Math.round(this.f3308y + (f4 * f2));
        }
        if (this.destroy) {
            return;
        }
        b bVarP = b.P();
        int[] iArrR = r();
        p pVar = new p(this.f3307x - 12, this.f3308y - 12, 24.0f, 24.0f);
        bVarP.getClass();
        ...
        if (this.type == ProjectileType.f3245b) {
            mapSpriteI.n(((Integer) arrayListL.get(0)).intValue(), this.damageData);
            this.destroy = true;
        }
        if (this.type == projectileType) {
            AreaEffects.d(this.f3307x, this.f3308y, mapSpriteI.q(), this.explosionID);
            this.destroy = true;
        }
        if (this.type == ProjectileType.f3246c) {
