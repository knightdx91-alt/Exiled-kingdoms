...
public class MapItem extends MapSprite {
    ...
    public static final class MapItemAction {
        ...
        public static final MapItemAction f3221b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        public static final MapItemAction f3222c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        public static final MapItemAction f3223d;

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        public static final MapItemAction f3224e;

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        public static final MapItemAction f3225f;

        /* JADX INFO: renamed from: g, reason: collision with root package name */
        public static final MapItemAction f3226g;

        /* JADX INFO: renamed from: h, reason: collision with root package name */
        public static final MapItemAction f3227h;

        /* JADX INFO: renamed from: i, reason: collision with root package name */
        public static final MapItemAction f3228i;

        /* JADX INFO: renamed from: j, reason: collision with root package name */
        private static final /* synthetic */ MapItemAction[] f3229j;

        static {
            MapItemAction mapItemAction = new MapItemAction("INVISIBLE", 0);
            f3221b = mapItemAction;
            MapItemAction mapItemAction2 = new MapItemAction("ACTIVE", 1);
            f3222c = mapItemAction2;
            MapItemAction mapItemAction3 = new MapItemAction("INACTIVE", 2);
            f3223d = mapItemAction3;
            MapItemAction mapItemAction4 = new MapItemAction("WALKABLE", 3);
            f3224e = mapItemAction4;
            MapItemAction mapItemAction5 = new MapItemAction("NONWALKABLE", 4);
            f3225f = mapItemAction5;
            MapItemAction mapItemAction6 = new MapItemAction("BLOCKSVIEW", 5);
            f3226g = mapItemAction6;
            MapItemAction mapItemAction7 = new MapItemAction("UNBLOCKSVIEW", 6);
            f3227h = mapItemAction7;
            MapItemAction mapItemAction8 = new MapItemAction("VISIBLE", 7);
            f3228i = mapItemAction8;
            f3229j = new MapItemAction[]{mapItemAction, mapItemAction2, mapItemAction3, mapItemAction4, mapItemAction5, mapItemAction6, mapItemAction7, mapItemAction8};
        }
        ...
        public static MapItemAction[] values() {
            return (MapItemAction[]) f3229j.clone();
        }
    }
    ...
    public static final class MapItemState {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public static final MapItemState f3230b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        public static final MapItemState f3231c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        public static final MapItemState f3232d;

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        private static final /* synthetic */ MapItemState[] f3233e;

        static {
            MapItemState mapItemState = new MapItemState("INVISIBLE", 0);
            f3230b = mapItemState;
            MapItemState mapItemState2 = new MapItemState("ACTIVE", 1);
            f3231c = mapItemState2;
            MapItemState mapItemState3 = new MapItemState("INACTIVE", 2);
            f3232d = mapItemState3;
            f3233e = new MapItemState[]{mapItemState, mapItemState2, mapItemState3};
        }
        ...
        public static MapItemState[] values() {
            return (MapItemState[]) f3233e.clone();
        }
    }
    ...
    public MapItem(h hVar) {
        ...
        T();
        MapItemState mapItemState = MapItemState.f3231c;
        this.state = mapItemState;
        boolean zA = hVar.a("inactive");
        MapItemState mapItemState2 = MapItemState.f3232d;
        if (zA) {
        ...
        MapItemState mapItemState3 = MapItemState.f3230b;
        if (zA2) {
        ...
        if (hVar.a("active_effect")) {
            ...
            int i2 = 0;
            while (true) {
                if (i2 >= GameAssets.f3569r) {
                    i2 = 0;
                    break;
                } else if (GameAssets.f3571s[i2].name.equals(string)) {
                    break;
                } else {
                    i2++;
                }
        ...
        String str = SkCylVE.dhecX;
        if (hVar.a(str)) {
            this.conditionsDeactivate = hVar.b(str).toString().trim();
        }
        this.barrier = false;
        if (hVar.a("barrier")) {
            this.barrier = true;
        ...
        for (String str : this.toggleItems.split(";", -1)) {
            if (!str.equals(this.tag)) {
                for (int i2 = 0; i2 < GameLevelData.r().size(); i2++) {
                    ...
                    MapItemState mapItemState = MapItemState.f3232d;
                    MapItemState mapItemState2 = MapItemState.f3231c;
                    if (!zEquals) {
    ...
    public final void F(SpriteBatch spriteBatch) {
        ...
        if (!this.effect) {
            ...
            spriteBatch.draw((TextureRegion) GameAssets.f3571s[this.animationIndex].animation.getKeyFrame(this.stateRelativeTime), H() - 42, I() - 8);
        }
    }
    ...
    public final void N(MapItemAction mapItemAction) {
        ...
        switch (iOrdinal) {
            case 0:
                this.state = MapItemState.f3230b;
                T();
                break;
            case 1:
                GameAssets.o("trap");
            ...
            case 2:
                GameAssets.o("trap");
                this.state = MapItemState.f3232d;
                T();
                if (Q()) {
                    S();
                }
    ...
    public final Boolean O() {
        return Boolean.valueOf(this.state == MapItemState.f3231c);
    }

    public final Boolean P() {
        return Boolean.valueOf(this.state == MapItemState.f3230b);
    }
    ...
    public final void R() {
        ...
        MapItemState mapItemState2 = MapItemState.f3231c;
        MapItemState mapItemState3 = MapItemState.f3232d;
    ...
    */
    public final void T() {
        ...
        if (!z3 || this.state != MapItemState.f3231c) {
            MapItemState mapItemState2 = MapItemState.f3232d;
            z2 = (z3 && this.state == mapItemState2) ? true : (this.bridge && ((mapItemState = this.state) == mapItemState2 || mapItemState == MapItemState.f3230b)) ? false : this.walkable;
        }
        if (z2) {
            b.P().f4022n[this.f3307x / 32][this.f3308y / 32] = 0;
        } else {
            b.P().f4022n[this.f3307x / 32][this.f3308y / 32] = 1;
        }
        if (this.blocksview) {
            b.P().f4024p[this.f3307x / 32][this.f3308y / 32] = 1;
        } else {
            b.P().f4024p[this.f3307x / 32][this.f3308y / 32] = 0;
        }
    }
