...
public class MapEffectEntity extends MapSprite {
    ...
    private static Color f3220b = new Color(1.0f, 1.0f, 1.0f, 1.0f);
    ...
    public MapEffectEntity(h hVar) {
        ...
        this.id = string;
        MapEffect mapEffect = new MapEffect(string, this.f3307x, this.f3308y, q(), false);
        this.mapeffect = mapEffect;
        boolean z2 = this.active;
        mapEffect.fullyActive = z2;
        mapEffect.tag_id = this.id;
        ...
        if (this.id.contains("glowing")) {
            ...
            this.originX = this.f3307x;
            this.originY = this.f3308y;
            P();
        }
    ...
    private void P() {
        ...
        qVar.a();
        this.speedX = qVar.f3178b * 145.0f;
        this.speedY = qVar.f3179c * 145.0f;
        this.nextDirectionChange = ((float) ((Math.random() * ((double) 0.6f)) + ((double) 0.0f))) + GameData.v().u() + 5.0f;
    }

    private void T() {
        MapEffectData.MapEffectDataLine mapEffectDataLineA = Rules.f3478k.a(this.id);
        ...
        if (this.nextDirectionChange > 0.0f) {
            ...
            if (b.s(coordsB, GameData.v().player.B()) <= 500) {
                ...
                if (this.lastbounce + 0.5f < GameData.v().u()) {
                    if (b.P().i((int) ((this.speedX * f2) + this.f3307x), this.f3308y, 5)) {
                    ...
                    if (b.P().i(this.f3307x, (int) ((this.speedY * f2) + this.f3308y), 5)) {
                ...
                this.mapeffect.e(this.f3307x, this.f3308y);
            }
        }
        if (!this.addedlight && this.mustaddlight) {
            w0.a.l().e(0.0f, q(), 90, "torch");
    ...
    public final void R() {
        if (this.id.contains("glowing")) {
            this.f3307x = this.originX;
            this.f3308y = this.originY;
            P();
        }
    }
    ...
    public final void U(int i2, int i3) {
        if (this.debug) {
            System.out.println("mapEffectEntity setTarget: " + i2 + lRWXeT.VFlpY + i3);
        }
        q qVar = new q();
        qVar.f3178b = i2;
        qVar.f3179c = i3;
