...
public class CharacterInventory {
    ...
    public final boolean c(int i2) {
        ...
        if (itemType == Item.ItemType.f3453e) {
            i3 = this.slot_head;
            this.slot_head = i4;
        }
        if (itemType == Item.ItemType.f3454f) {
            i3 = this.slot_body;
            this.slot_body = i4;
        }
        if (itemType == Item.ItemType.f3457i) {
            i3 = this.slot_hands;
            this.slot_hands = i4;
        }
        if (itemType == Item.ItemType.f3455g) {
            i3 = this.slot_feet;
            this.slot_feet = i4;
        }
        if (itemType == Item.ItemType.f3456h) {
            i3 = this.slot_legs;
            this.slot_legs = i4;
        }
        ...
        if (itemType != Item.ItemType.f3461m) {
            i5 = i3;
        } else {
            i3 = this.slot_ring;
            if (i3 == 0) {
        ...
        if (itemType == Item.ItemType.f3462n) {
            i5 = this.slot_belt;
            this.slot_belt = i4;
        }
        if (itemType == Item.ItemType.f3463o) {
            i5 = this.slot_cloak;
            this.slot_cloak = i4;
        }
        if (itemType == Item.ItemType.f3464p) {
    ...
    public final int u() {
        int iT = 0 + t(this.slot_body) + t(this.slot_head) + t(this.slot_hands) + t(this.slot_legs) + t(this.slot_feet) + t(this.slot_mainhand);
        if (!this.twohander) {
            iT += t(this.slot_offhand);
        }
        return iT + t(this.slot_ring) + t(this.slot_ring2) + t(this.slot_belt) + t(this.slot_cloak) + t(this.slot_necklace);
    }

    public final int v() {
        return t(this.slot_mainhand);
    }
}
