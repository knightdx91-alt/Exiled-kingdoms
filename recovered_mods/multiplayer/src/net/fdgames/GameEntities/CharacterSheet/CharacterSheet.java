...
public class CharacterSheet {
    ...
    public static boolean b(int i2) {
        ...
        if (!zA) {
            ...
            GameLevelData.d(new Loot(GameData.v().player.f3307x + 32, GameData.v().player.f3308y + 32, i2));
            GameData.v().log.a(KOdB.emjISSALdmu);
            if (i2 != 0 && Rules.f(i2).value < 0) {
                new a(GameString.b("WARNING_DROPPED", false), 0).show(z.w().a());
            }
        }
        return zA;
    }
    ...
    private final boolean isPlayerModEnabled(String str) {
        return isPlayerSheet() && GameData.v().gameVariables.b(str) > 0;
    }

    private final boolean isPlayerSheet() {
        Player player = GameData.v().player;
        return player != null && player.sheet == this;
    }
    ...
    public final int A() {
        ...
        if (this.stats.c().equals(Rules.CharacterClass.f3482e)) {
            iF = this.stats.f() * ((iD2 / 2) + iD + 2);
        } else {
            iF = 0;
        }
        if (this.stats.c().equals(Rules.CharacterClass.f3481d)) {
    ...
    public final int B(boolean z2) {
        if (z2) {
            ...
            return m() + this.inventory.j().maxDamage + 1 + Rules.cdxUpgradeBonusMax(Rules.cdxUpgradeLevel(this.inventory.slot_mainhand));
        }
        WeaponStats weaponStats2 = this.hardcoded_weapon;
        if (weaponStats2 != null) {
            return m() + weaponStats2.minDamage;
        }
        return m() + this.inventory.j().minDamage + Rules.cdxUpgradeBonusMin(Rules.cdxUpgradeLevel(this.inventory.slot_mainhand));
    }
    ...
    public final int E() {
        int iG = G(Damage.DamageType.f3267h);
        if (iG == 0) {
            return 0;
        }
    ...
    public final int F(CharacterResistances.ResistanceType resistanceType) {
        ...
        if (resistanceType == CharacterResistances.ResistanceType.f3213e) {
            iA = (this.skillSet.g("death_ward") * 12) + (SheetBonus.d(J(), 5, this.inventory, this.effects) * 5) + iA;
        }
        if (resistanceType == CharacterResistances.ResistanceType.f3215g) {
            iA = (this.skillSet.g("spiritual_ward") * 10) + (SheetBonus.d(J(), 5, this.inventory, this.effects) * 2) + iA;
        }
        if (resistanceType == CharacterResistances.ResistanceType.f3214f) {
            iA = (this.skillSet.g(IUcMoQOkPHcA.irwEhZpmSS) * 10) + (SheetBonus.d(J(), 1, this.inventory, this.effects) * 5) + iA + (this.skillSet.g("toxic_ward") * 12);
        }
        if (resistanceType == CharacterResistances.ResistanceType.f3210b) {
            iA = (this.skillSet.g("fire_ward") * 12) + iA + i2;
        }
        if (resistanceType == CharacterResistances.ResistanceType.f3211c) {
            iA = (this.skillSet.g("ice_ward") * 12) + iA + i2;
        }
        return resistanceType == CharacterResistances.ResistanceType.f3212d ? (this.skillSet.g("shock_ward") * 12) + iA + i2 : iA;
    }

    public final int G(Damage.DamageType damageType) {
        switch (damageType.ordinal()) {
            case 1:
                return F(CharacterResistances.ResistanceType.f3210b);
            case 2:
                return F(CharacterResistances.ResistanceType.f3211c);
            case 3:
                return F(CharacterResistances.ResistanceType.f3212d);
            case 4:
                return F(CharacterResistances.ResistanceType.f3213e);
            case 5:
                return F(CharacterResistances.ResistanceType.f3214f);
            case 6:
                return F(CharacterResistances.ResistanceType.f3215g);
            default:
                return 0;
        }
    }
    ...
    public final int H() {
        ...
        WeaponStats weaponStats = this.hardcoded_weapon;
        if (weaponStats != null) {
            fB = SheetBonus.b(this, weaponStats.a()) * weaponStats.speed;
        } else {
            fB = SheetBonus.b(this, this.inventory.j().a()) * r0.speed;
        }
        if (isPlayerModEnabled("mod_fast_cooldown")) {
            fB *= 4.0f;
        }
        return (int) fB;
    }
    ...
    public final boolean V() {
        return this.stats.c().equals(Rules.CharacterClass.f3482e) || this.stats.c().equals(Rules.CharacterClass.f3481d);
    }
    ...
    public final boolean c0(int i2) {
        if (isPlayerModEnabled("mod_infinite_mana") || p() >= i2) {
            return true;
        }
    ...
    public final float f0() {
        int iG0 = g0(100, F(CharacterResistances.ResistanceType.f3215g));
    ...
    public final void h0(WeaponStats weaponStats, int i2, int i3, CharacterResistances characterResistances, String str) {
        if (weaponStats != null) {
            ...
            if (lowerCase.contains(fApIihhYHIP.OtETzRzBo)) {
            ...
            if (lowerCase.contains(cxRMW.WBatKgCo)) {
            ...
            if (lowerCase.contains(rFUF.kRybLeXLNs)) {
                attributesSet.undead = true;
    ...
    */
    public final DamageData i(float f2, boolean z2, boolean z3) {
        ...
        Damage.DamageType damageType2 = Damage.DamageType.f3262c;
        if (z5) {
            Damage.DamageType damageType3 = this.inventory.j().secondary_damageType;
            int iCdxUpgradeBonusElemental = this.inventory.j().secondary_Damage + Rules.cdxUpgradeBonusElemental(Rules.cdxUpgradeLevel(this.inventory.slot_mainhand));
            if (this.stats.c() != Rules.CharacterClass.f3482e || N().ranged) {
                f3 = iCdxUpgradeBonusElemental;
            } else {
                f3 = iCdxUpgradeBonusElemental;
                if (damageType3 == Damage.DamageType.f3265f) {
                    ...
                    f3 *= f4;
                } else if (damageType3 == Damage.DamageType.f3263d || damageType3 == damageType2 || damageType3 == Damage.DamageType.f3264e) {
                    int iG2 = this.skillSet.g(lRWXeT.gBRmIUU);
                    if (iG2 == 0 || iG2 == 1) {
                        f3 *= f4;
                    } else if (iG2 == 2) {
                        f3 *= 1.5f;
        ...
        if (this.effects.poison.booleanValue()) {
            damageData.a(Damage.DamageType.f3266g, this.effects.poisonBonus, false);
        }
    ...
    public final int j() {
        ...
        int iG = (!Z() || N().twohanded) ? 0 : this.skillSet.g(fNqLzGyLIBqug.hNhIr);
    ...
    public final void j0(int i2) {
        if (isPlayerModEnabled("mod_infinite_mana")) {
            return;
        }
        if (p() >= i2) {
    ...
    public final void l0() {
        if (isPlayerSheet() && isPlayerModEnabled("mod_no_damage")) {
            GameVariables gameVariables = GameData.v().gameVariables;
            int iB = gameVariables.b("mod_no_damage_missing_hp_anchor");
            CharacterStats characterStats = this.stats;
            int i2 = characterStats.missingHP;
            if (iB == 0) {
                iB = i2 + 1;
                gameVariables.e(iB, "mod_no_damage_missing_hp_anchor");
            }
            int i3 = iB - 1;
            if (i2 > i3) {
                characterStats.missingHP = i3;
    ...
    public final int m() {
        int iC = SheetBonus.c(this, N().a());
        return this.hardcoded_weapon == null ? iC + this.inventory.v() : iC;
    }
    ...
    */
    ...
    public final int s() {
        int i2 = 0;
        int i3 = this.stats.c() == Rules.CharacterClass.f3480c ? 15 : 0;
    ...
    public final int t() {
        ...
        int iD2 = SheetBonus.d(J(), 3, this.inventory, this.effects);
        int i2 = this.stats.c() == Rules.CharacterClass.f3480c ? 20 : 0;
        return this.inventory.f() + (((iD2 / 2) + iD) * 5) + (this.skillSet.g("trap_master") > 0 ? this.skillSet.g("trap_master") * 10 : 0) + i2;
    }

    public final int u() {
        return this.inventory.g() + (((SheetBonus.d(J(), 4, this.inventory, this.effects) / 2) + SheetBonus.d(J(), 5, this.inventory, this.effects)) * 5) + this.skillSet.bonusSet.gossip + (this.stats.c().equals(Rules.CharacterClass.f3480c) ? 10 : 0);
    }

    public final int v() {
        CharacterInventory characterInventory = this.inventory;
        if (characterInventory != null && characterInventory.q() && Rules.f(this.inventory.slot_offhand).damageBonusType == Damage.DamageType.f3261b) {
