...
public class CharacterResistances {
    ...
    public static final class ResistanceType {
        ...
        public static final ResistanceType f3210b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        public static final ResistanceType f3211c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        public static final ResistanceType f3212d;

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        public static final ResistanceType f3213e;

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        public static final ResistanceType f3214f;

        /* JADX INFO: renamed from: g, reason: collision with root package name */
        public static final ResistanceType f3215g;

        /* JADX INFO: renamed from: h, reason: collision with root package name */
        private static final /* synthetic */ ResistanceType[] f3216h;

        static {
            ResistanceType resistanceType = new ResistanceType("Fire", 0);
            f3210b = resistanceType;
            ResistanceType resistanceType2 = new ResistanceType("Cold", 1);
            f3211c = resistanceType2;
            ResistanceType resistanceType3 = new ResistanceType("Shock", 2);
            f3212d = resistanceType3;
            ResistanceType resistanceType4 = new ResistanceType("Death", 3);
            f3213e = resistanceType4;
            ResistanceType resistanceType5 = new ResistanceType("Toxic", 4);
            f3214f = resistanceType5;
            ResistanceType resistanceType6 = new ResistanceType("Spirit", 5);
            f3215g = resistanceType6;
            f3216h = new ResistanceType[]{resistanceType, resistanceType2, resistanceType3, resistanceType4, resistanceType5, resistanceType6};
        }
        ...
        public static ResistanceType[] values() {
            return (ResistanceType[]) f3216h.clone();
        }
    }
