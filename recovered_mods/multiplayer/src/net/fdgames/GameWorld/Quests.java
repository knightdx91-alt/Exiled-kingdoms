...
public class Quests {
    ...
    public static ArrayList<Quest> f3417a = new ArrayList<>();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static ArrayList<QuestLocation> f3418b = new ArrayList<>();
    ...
    public Quests() {
        ...
        for (int i3 = 0; i3 < strArrSplit3.length; i3++) {
            ...
            try {
                f3417a.add(new Quest(strArrSplit4[0]));
            } catch (Exception unused) {
                l.e("ExiledKingdoms.GameWorld.load() -        >     >  ERROR! quest:" + strArrSplit4[0]);
            }
        }
        l.e("ExiledKingdoms.GameWorld.load() -        >     >" + f3417a.size() + " quests added");
    }

    public static Quest a(String str) {
        for (Quest quest : f3417a) {
            if (quest.i(str)) {
                return quest;
            }
        }
    ...
    */
    public static String b(int i2, String str) {
        ...
        for (QuestLocation questLocation : f3418b) {
            if (questLocation.id.equals(str)) {
                StringBuilder sb = new StringBuilder();
                sb.append(GameWorld.f3413f.a(strSubstring));
                sb.append(", ");
                if (Settings.h() == 2) {
