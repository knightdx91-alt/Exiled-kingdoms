...
public class DynamicQuest {
    ...
    public DynamicQuest(String str, String str2) {
        ...
        if (Quests.a(str) != null) {
            ...
            if (Quests.a(str).f()) {
                ...
                Quests quests4 = GameWorld.f3408a;
                ...
                Quests quests5 = GameWorld.f3408a;
    ...
    public final String g(int i2) {
        ...
        String strReplace = strC.replace("#QUESTGIVER#", "[BLUE]" + GameWorld.f3409b.a(this.castleID).c() + "[]");
        ...
        sb.append("[]");
        return a.l("[BLACK]", FDUtils.e(strReplace.replace(JDxjJEGD.jSTWz, sb.toString()).replace("#LOCATION#", "[BLUE]" + Quests.b(this.knowledge, this.location_ID) + "[]").replace("#REWARD#", "[BLUE]" + Rules.h(this.difficulty_level, this.rewardTable) + "[]")), "[]");
    }
        ...
        if (z2) {
            ...
            if (!questVariationD.rivalFaction.trim().equals("") && questVariationD.rivalFaction.contains("#")) {
                ...
                while (it.hasNext()) {
                    ...
                    GameWorld.f3410c.a(Integer.parseInt(strArrSplit[1]) * (-1), 999, strArrSplit[0]);
                }
            }
        } else {
            i2 = questVariationD.factionLoss * (-1);
        }
        if (GameWorld.f3409b.a(this.castleID).faction_id2.equals("")) {
            GameWorld.f3410c.a(i2, questVariationD.maxFactionGain, GameWorld.f3409b.a(this.castleID).faction_id);
            return;
        }
        int i3 = i2 / 2;
        GameWorld.f3410c.a(i3, questVariationD.maxFactionGain, GameWorld.f3409b.a(this.castleID).faction_id);
        GameWorld.f3410c.a(i3, questVariationD.maxFactionGain, GameWorld.f3409b.a(this.castleID).faction_id2);
    }
}
