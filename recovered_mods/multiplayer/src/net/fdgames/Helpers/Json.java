...
public class Json {
    ...
    public Json() {
        ...
        this.outputType = u.b.f2754c;
    }

    public Json(u.b bVar) {
        this.typeName = VEZT.MTnPkobJxYrW;
        this.usePrototypes = true;
        this.enumNames = true;
        this.typeToFields = new y<>();
        this.tagToClass = new y<>();
    ...
    */
    private y<String, a> cacheFields(Class cls) {
        ...
        for (Class superclass = cls; superclass != Object.class; superclass = superclass.getSuperclass()) {
            Collections.addAll(arrayList, t0.a.d(superclass));
        }
            ...
            if (!cVar.j() && !cVar.h() && !cVar.i()) {
                if (cVar.f()) {
                    ...
                    if (y.class.isAssignableFrom(cVar.e())) {
                        aVar.f3444b = cVar.c((!y.class.isAssignableFrom(cVar.e()) || Map.class.isAssignableFrom(cVar.e())) ? 1 : 0);
                        yVar.j(strD, aVar);
                    }
                } else {
                    try {
                        ...
                        a aVar2 = new a();
                        aVar2.f3443a = cVar;
                        aVar2.f3444b = cVar.c((!y.class.isAssignableFrom(cVar.e()) || Map.class.isAssignableFrom(cVar.e())) ? 1 : 0);
                        yVar.j(strD2, aVar2);
    ...
    private Object[] getDefaultValues(Class cls) {
        ...
        try {
            ...
            Object[] objArr = new Object[yVarD.f2811b];
            this.classToDefaultValues.j(cls, objArr);
            y.e<a> eVarN = yVarD.n();
            eVarN.getClass();
            int i2 = 0;
            while (eVarN.hasNext()) {
                c cVar = eVarN.next().f3443a;
                int i3 = i2 + 1;
                try {
                    ...
                    throw new h0("Error accessing field: " + cVar.d() + " (" + cls.getName() + ")", e4);
                }
            }
            return objArr;
    ...
    protected Object newInstance(Class cls) {
        try {
            ...
            e = e2;
            try {
                b bVarC = t0.a.c(cls, new Class[0]);
                bVarC.c();
                ...
                if (cls.isArray()) {
                    throw new h0(JDxjJEGD.nuurdEQPkkD.concat(cls.getName()), e);
                }
    ...
    public void readField(Object obj, String str, String str2, Class cls, t tVar) {
        ...
        a aVarD = yVarD.d(str);
        if (aVarD == null) {
            StringBuilder sbT = a.a.t("Field not found: ", str, " (");
            sbT.append(cls2.getName());
            sbT.append(")");
        ...
        try {
            ...
            throw new h0("Error accessing field: " + cVar.d() + " (" + cls2.getName() + ")", e4);
        }
    }
    ...
    public void readFields(Object obj, t tVar) {
        ...
        for (t tVar2 = tVar.f2726g; tVar2 != null; tVar2 = tVar2.f2728i) {
            a aVarD = yVarD.d(tVar2.f2725f);
            if (aVarD != null) {
                c cVar = aVarD.f3443a;
                try {
                    cVar.k(obj, readValue(cVar.e(), aVarD.f3444b, tVar2));
                } catch (h0 e2) {
                    ...
                    throw new h0(rFUF.tjWmvjumhqytnJI + cVar.d() + " (" + cls.getName() + ")", e4);
                }
            } else if (!this.ignoreUnknownFields) {
                throw new h0("Field not found: " + tVar2.f2725f + " (" + cls.getName() + ")");
            }
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:259:0x0368 A[RETURN] */
    ...
    /* JADX WARN: Type inference failed for: r3v44, types: [net.fdgames.Helpers.Json$Serializer] */
    /* JADX WARN: Type inference failed for: r3v5 */
    /* JADX WARN: Type inference failed for: r3v53, types: [net.fdgames.Helpers.Json$Serializable] */
    /* JADX WARN: Type inference failed for: r3v55, types: [net.fdgames.Helpers.Json$Serializer] */
    ...
    public <T> T readValue(Class<T> cls, Class cls2, t tVar) {
        ...
        if (tVar.t()) {
            ...
            if (strO != null) {
                ...
                if (tVarK == null) {
                    ...
                    t tVar4 = tVarK.f2729j;
                    if (tVar4 == null) {
                        t tVar5 = tVarK.f2728i;
                        r22.f2726g = tVar5;
                        if (tVar5 != null) {
                            tVar5.f2729j = null;
                        }
                        ...
                        cls6 = Collection.class;
                        tVar4.f2728i = tVarK.f2728i;
                        t tVar6 = tVarK.f2728i;
                        if (tVar6 != null) {
                            tVar6.f2729j = tVar4;
                        }
                    }
            ...
            if (clsD == String.class || clsD == Integer.class || clsD == Boolean.class || clsD == Float.class || clsD == Long.class || clsD == Double.class || clsD == Short.class || clsD == Byte.class || clsD == Character.class || Enum.class.isAssignableFrom(clsD)) {
                return (T) readValue(BQmoQ.EThTXKFqIPnYy, clsD, r22);
            }
            ...
            if (r02 instanceof y) {
                ?? r03 = (T) ((y) r02);
                for (t tVar7 = r22.f2726g; tVar7 != null; tVar7 = tVar7.f2728i) {
                    r03.j(tVar7.f2725f, readValue(cls2, null, tVar7));
                }
                return r03;
            }
            if (r02 instanceof com.badlogic.gdx.utils.b) {
                ?? r04 = (T) ((com.badlogic.gdx.utils.b) r02);
                for (t tVar8 = r22.f2726g; tVar8 != null; tVar8 = tVar8.f2728i) {
                    r04.c(tVar8.f2725f, readValue(cls2, null, tVar8));
                }
                return r04;
            }
            ...
            ?? r05 = (T) ((Map) r02);
            for (t tVar9 = r22.f2726g; tVar9 != null; tVar9 = tVar9.f2728i) {
                r05.put(tVar9.f2725f, readValue(cls2, null, tVar9));
            }
            return r05;
        }
        cls3 = cls2;
        ...
        if (r2.q()) {
            ...
            if (com.badlogic.gdx.utils.a.class.isAssignableFrom(clsD)) {
                ...
                for (t tVar10 = r2.f2726g; tVar10 != null; tVar10 = tVar10.f2728i) {
            ...
            if (cls4.isAssignableFrom(clsD)) {
                ...
                for (t tVar11 = r2.f2726g; tVar11 != null; tVar11 = tVar11.f2728i) {
            ...
            T t3 = (T) Array.newInstance(componentType, r2.f2730k);
            t tVar12 = r2.f2726g;
            while (tVar12 != null) {
                Array.set(t3, i2, readValue(cls3, null, tVar12));
                tVar12 = tVar12.f2728i;
                i2++;
            }
            return t3;
        }
    ...
    public void writeFields(Object obj) {
        ...
        while (eVar.hasNext()) {
            ...
            try {
                ...
                writeValue(objA, cVar.e(), aVar.f3444b);
            } catch (h0 e2) {
                e2.a(cVar + " (" + cls.getName() + ")");
                throw e2;
            } catch (e e3) {
    ...
    public void writeValue(Object obj, Class cls, Class cls2) {
        ...
        try {
            ...
            if (obj instanceof y) {
                ...
                while (aVarB.hasNext()) {
                    y.b next = aVarB.next();
                    this.writer.b(convertToString(next.f2825a));
                    writeValue(next.f2826b, cls2, (Class) null);
                }
                writeObjectEnd();
                return;
            }
            if (obj instanceof com.badlogic.gdx.utils.b) {
                ...
                int i4 = bVar.f2534d;
                while (i2 < i4) {
                    this.writer.b(convertToString(bVar.f2532b[i2]));
                    writeValue(bVar.f2533c[i2], cls2, (Class) null);
                    i2++;
                }
                writeObjectEnd();
                return;
