...
public class GPGSUpdate {
    ...
    private static boolean f3633l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    private static boolean f3634m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    private static boolean f3635n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    private static boolean f3636o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    private static boolean f3637p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    private static boolean f3638q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    private static boolean f3639r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    private static boolean f3640s;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    private static boolean f3641t;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    private static boolean f3642u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    private static boolean f3643v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    private static boolean f3644w;

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    private static boolean f3645x;

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    private static boolean f3646y;

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    private static boolean f3647z;

    public static void a() {
        if (ExiledKingdoms.f3606h || ExiledKingdoms.f() == null || !((MainActivity) ExiledKingdoms.f()).l()) {
            return;
        }
        ...
        if (i2 > 0 && !f3646y) {
            ((MainActivity) ExiledKingdoms.f()).t(EGEEZWr.ItBvVBGeSgnSuZM);
            f3646y = true;
        }
        if (i2 > 1 && !f3647z) {
        ...
        ((MainActivity) ExiledKingdoms.f()).t(BQmoQ.YiEBvR);
        A = true;
    }
    ...
    public static void c(boolean z2) {
        String str = lxYOBQSyWPCj.PHolFAYCgB;
        ...
        if (!GameLevel.l() && !ExiledKingdoms.f3606h) {
            b.f3910s = true;
            return;
        }
        b.f3910s = false;
        ...
        try {
            ...
            if (GameData.v().G()) {
                ...
                if (((MainActivity) ExiledKingdoms.f()).l() && i3 > Settings.e("GL_ironman_score")) {
                    Settings.C(i3, "GL_ironman_score");
            ...
            if (((MainActivity) ExiledKingdoms.f()).l() && i4 > Settings.e(str)) {
                Settings.C(i4, str);
    ...
    private static int d() {
        ...
        if (ExiledKingdoms.f() != null && ((MainActivity) ExiledKingdoms.f()).l()) {
            ...
            String str2 = ReTXwDyZpZSd.qcqwYGOnDbmMx;
            mainActivity.q(i3, str2);
            ((MainActivity) ExiledKingdoms.f()).q(i3, "CgkIg8PLzvILEAIQFA");
            MainActivity mainActivity2 = (MainActivity) ExiledKingdoms.f();
            String str3 = qJDUJ.TBbHwWslTa;
            mainActivity2.q(i3, str3);
            if (i3 >= 4) {
                ((MainActivity) ExiledKingdoms.f()).t(str2);
                ((MainActivity) ExiledKingdoms.f()).p("CgkIg8PLzvILEAIQFA");
                i2++;
            }
            if (i3 >= 12) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQFA");
                ((MainActivity) ExiledKingdoms.f()).p(str3);
                i2++;
            }
            if (i3 >= 25) {
                ((MainActivity) ExiledKingdoms.f()).t(str3);
    ...
    private static int h() {
        int i2;
        if (ExiledKingdoms.f() != null && ((MainActivity) ExiledKingdoms.f()).l()) {
            if (f3643v || GameData.v().gameVariables.b("guild_warriors") > 0) {
            ...
            if (f3644w || GameData.v().gameVariables.b("guild_seventh") > 0) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQJQ");
                i2++;
                f3644w = true;
            }
            if (f3645x || GameData.v().gameVariables.b("guild_three") > 0) {
            ...
            if (f3635n || GameData.v().H("undermother")) {
            ...
            if (D || GameData.v().gameVariables.b(JNrsKSCxIEXndG.TSvZcsTRJsqQ) > 0) {
            ...
            if (GameData.v().gameVariables.b(SkCylVE.Xzjznjuyju) >= 100) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQKg");
                i2++;
            }
            if (G || GameData.v().gameVariables.b(fIsXh.HewRXwSVHgvxkI) == 100) {
                ((MainActivity) ExiledKingdoms.f()).t(ZeMa.uYtbrbDbwJw);
                i2++;
                G = true;
            }
            if (H || GameData.v().gameVariables.b("sewer_horrors") == 100) {
                ...
                H = true;
                if (GameData.v().E()) {
                    ((MainActivity) ExiledKingdoms.f()).t(fIsXh.ScmPpgeL);
                    i2 += 2;
                } else {
                    i2 = i3;
                }
            ...
            if (f3637p || GameData.v().gameVariables.b("dragonslayer") > 0) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQIA");
                i2++;
                f3637p = true;
            }
            if (f3641t || GameData.v().gameVariables.b(RCsZWh.ClrAizgoHYj) == 110) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQQQ");
                i2++;
                f3641t = true;
            }
            if (f3642u || GameData.v().gameVariables.b("um_unweakened") == 1 || (GameData.v().H("zuzsare") && GameData.v().H("undermother"))) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQQg");
                i2++;
                f3642u = true;
            }
            if (f3633l || GameData.v().gameVariables.b("play_result") == 3) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQOA");
                i2++;
                f3633l = true;
            }
            if (f3625d || GameData.v().party.companions.size() > 0) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQFw");
                int i5 = i2 + 1;
                f3625d = true;
                if (f3623b || GameData.v().party.m("adaon")) {
                    ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQCQ");
                    i5 = i2 + 2;
                    f3623b = true;
                }
                if (f3622a || GameData.v().party.m("grissenda")) {
                    ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQCg");
                    i5++;
                    f3622a = true;
                }
                i2 = i5;
                if (f3624c || GameData.v().party.m("hirge")) {
                    ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQNA");
                    i2++;
                    f3624c = true;
                }
            }
            if (f3640s || GameData.v().gameVariables.b("mangled_god") == 110) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQKQ");
                i2++;
                f3640s = true;
            }
            if (f3636o || GameData.v().gameVariables.b("shards_fate") > 90) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQPg");
                i2++;
                f3636o = true;
            }
            if (f3626e || GameData.v().gameVariables.b(VEZT.cmvc) > 0) {
            ...
            if (f3632k || GameData.v().gameVariables.b("poisoned_river") == 100) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQOQ");
                i2++;
                f3632k = true;
            }
            if (f3629h || GameData.v().gameVariables.b(yorS.uAhQxFUEBVb) >= 90) {
                ((MainActivity) ExiledKingdoms.f()).t(fApIihhYHIP.dYOBiStUBCWe);
                i2++;
                f3629h = true;
            }
            if (f3628g || GameData.v().gameVariables.b(fIsXh.QIYA) == 100) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQMw");
                i2++;
                f3628g = true;
            }
            if (f3639r || GameData.v().gameVariables.b("key_to_past") >= 50 || GameData.v().gameVariables.b("NG_house") > 0 || GameData.v().gameVariables.b("NI_house") > 0) {
                ((MainActivity) ExiledKingdoms.f()).t(MbzYTTrg.zMk);
                i2++;
                f3639r = true;
            }
            if (f3627f || GameData.v().gameVariables.b(qJDUJ.JVrFLQTAcJwN) == 100) {
                ((MainActivity) ExiledKingdoms.f()).t("CgkIg8PLzvILEAIQIQ");
                i2++;
                f3627f = true;
            }
            if (f3630i || GameData.v().gameVariables.b("seed_of_trust") == 110) {
            ...
            if (N) {
                ...
                if (GameData.v().gameVariables.b(VEZT.TVhfDoXuwzrbQ) == 1) {
                    i++;
                }
    ...
    private static int j() {
        ...
        if (ExiledKingdoms.f() != null && ((MainActivity) ExiledKingdoms.f()).l()) {
            ...
            MainActivity mainActivity = (MainActivity) ExiledKingdoms.f();
            String str = fIsXh.TPHNAM;
            mainActivity.q(i3, str);
            ...
            if (i3 >= 18) {
                ...
                ((MainActivity) ExiledKingdoms.f()).p(str);
                i2++;
            }
            if (i3 >= 36) {
                ((MainActivity) ExiledKingdoms.f()).t(str);
