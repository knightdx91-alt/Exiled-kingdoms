...
import net.fdgames.ek.android.lan.LanLobbyActivity;
...
public class MainActivity extends AndroidApplication implements IPlatformResolver {
    ...
    public static final /* synthetic */ int f3652b = 0;
    public static a safBackupWindow;
    ...
    private static String g(String str) {
        ...
        for (char c2 : str.toCharArray()) {
            if (z2 && Character.isLetter(c2)) {
                StringBuilder sbR = a.a.r(string);
                sbR.append(Character.toUpperCase(c2));
                string = sbR.toString();
                z2 = false;
            } else {
        ...
        if (!zL) {
            ...
            this.mSnapshotsClient.open("EK_GAME_SAVE", true, 3).addOnFailureListener(new OnFailureListener() { // from class: net.fdgames.ek.android.MainActivity.9
                ...
                public final byte[] then(Task<SnapshotsClient.DataOrConflict<Snapshot>> task) {
                    ...
                    try {
                        aVar.h(a.k.f1934c, 0, data.getSnapshotContents().readFully(), data.getMetadata().getDescription());
                    } catch (IOException e2) {
                        int i2 = MainActivity.f3652b;
                        Log.e("GPGS_debug", "Error while opening Snapshot.", e2);
                        MainActivity.this.GPGSerror = 16;
                        aVar.h(a.k.f1936e, 16, null, e2.getLocalizedMessage());
                    }
                    return null;
                }
    ...
    public final void b(final a aVar, final byte[] bArr) {
        this.GPGSerror = 0;
        boolean zL = l();
        a.k kVar = a.k.f1935d;
        if (!zL) {
    ...
    public final void i() {
        ...
        if (!ExiledKingdoms.f3605g || (achievementsClient = this.mAchievementsClient) == null) {
            return;
        }
    ...
    public final void k(boolean z2) {
        ...
        if (!ExiledKingdoms.f3605g || (leaderboardsClient = this.mLeaderboardsClient) == null) {
            return;
        }
        leaderboardsClient.getLeaderboardIntent(z2 ? "CgkIg8PLzvILEAIQUQ" : vIBRkbZbNjpf.wGCgFq).addOnSuccessListener(new OnSuccessListener<Intent>() { // from class: net.fdgames.ek.android.MainActivity.4
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Intent intent) {
                MainActivity.this.startActivityForResult(intent, 5001);
            }
            ...
            @Override // com.google.android.gms.tasks.OnFailureListener
            public final void onFailure(Exception exc) {
                System.out.println(JNrsKSCxIEXndG.rMnCp + exc.getLocalizedMessage());
            }
        });
    }
    ...
    public final void launchExportPicker() {
        Intent intent = new Intent("android.intent.action.CREATE_DOCUMENT");
        intent.addCategory("android.intent.category.OPENABLE");
        intent.setType("application/octet-stream");
        intent.putExtra("android.intent.extra.TITLE", "EK.bak");
        startActivityForResult(intent, 47818);
    }

    public final void launchImportPicker() {
    ...
    protected final void onActivityResult(int i2, int i3, Intent intent) {
        if (i2 == 47818 && i3 == -1 && intent != null) {
            try {
                Uri data = intent.getData();
                if (data != null) {
                    OutputStream outputStreamOpenOutputStream = getContentResolver().openOutputStream(data);
                    Serializer.exportToOutputStream(outputStreamOpenOutputStream);
                    outputStreamOpenOutputStream.close();
                    l.e("SAF Export: success");
                    return;
                }
            } catch (Exception e2) {
                e2.printStackTrace();
                l.e("SAF Export: FAILED");
                return;
            }
        }
        if (i2 == 47820 && i3 == -1 && intent != null) {
            try {
                Uri data2 = intent.getData();
                if (data2 != null) {
                    InputStream inputStreamOpenInputStream = getContentResolver().openInputStream(data2);
                    Serializer.importFromInputStream(inputStreamOpenInputStream);
                    inputStreamOpenInputStream.close();
                    l.e("SAF Import: success");
                    return;
                }
            } catch (Exception e3) {
                e3.printStackTrace();
                l.e("SAF Import: FAILED");
                return;
            }
        }
        if (ExiledKingdoms.f3605g) {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        ExiledKingdoms.f3614p = new e1.a(exiledKingdoms, this);
    }
    ...
    public final void onResume() {
        b.f3902k = false;
        super.onResume();
        boolean z2 = ExiledKingdoms.f3605g;
        if (z2 && z2) {
    ...
    public final void q(int i2, String str) {
        AchievementsClient achievementsClient;
        if (!ExiledKingdoms.f3605g || (achievementsClient = this.mAchievementsClient) == null || i2 <= 0) {
            return;
        }
    ...
    public final void u() {
        startActivity(new Intent(this, (Class<?>) LanLobbyActivity.class));
    }
}
