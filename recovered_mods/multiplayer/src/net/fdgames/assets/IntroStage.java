...
public class IntroStage {
    ...
    public static final class Direction {
        ...
        public static final Direction f3590b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private static final /* synthetic */ Direction[] f3591c;
        ...
        static {
            ...
            f3590b = direction4;
            f3591c = new Direction[]{direction, direction2, direction3, direction4};
        }
        ...
        public static Direction[] values() {
            return (Direction[]) f3591c.clone();
        }
    }

    public IntroStage(String str, String str2, float f2, Color color) {
        Direction direction = Direction.f3590b;
