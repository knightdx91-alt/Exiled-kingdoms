...
public class SkillActions {
    ...
    public static void b(Character character, boolean z2) {
        ...
        while (true) {
            ...
            secretDoorState = SecretDoor.SecretDoorState.f3249b;
            if (!zHasNext) {
                break;
            }
        ...
        if (i4 > 0) {
            if (!z2) {
                ...
                a.v("DOORS_REMAINING_1", false, sb, " [BLUE]some[] ");
                sb.append(GameString.b("DOORS_REMAINING_2", false));
                gameLog.a(sb.toString());
                return;
            }
            GameData.v().log.a(GameString.b("DOORS_REMAINING_1", false) + " [BLUE]" + i4 + MbzYTTrg.hXXuJvNpr + GameString.b("DOORS_REMAINING_2", false));
        }
    }
    ...
    public static void d(Character character) {
        ...
        w0.a.l().a(new w(character.q(), "FURY!", 1.0f, Color.BLUE, 1.2f, 0.7f));
    }

    public static void e(Character character) {
        SkillSet skillSet = character.sheet.skillSet;
        String str = gNaSiQJmMEn.TgEMCXxfGIgPM;
        int iG = skillSet.g(str);
        if (iG == 1 || iG == 2 || iG == 3) {
            character.c1();
        }
        character.sheet.skillSet.s(str);
        w0.a.l().a(new w(character.q(), "Flurry!", 0.7f, Color.GREEN, 1.0f, 0.7f));
    }
    ...
    public static DamageEffect f(int i2) {
        ...
        DamageEffect.EffectType effectType = DamageEffect.EffectType.f3269b;
        if (i2 == 1) {
    ...
    */
            ...
            if (str.equals("G7_tomb")) {
                ...
                if (GameData.v().player.sheet.Q(2618) <= 0) {
                    if (!b.P().f4020l) {
                        ...
                        } else if (str.contains(SkCylVE.vjDxMTkdJ)) {
                        ...
                        } else if (str.contains(lxYOBQSyWPCj.CfG) || str.contains("H6") || str.contains("G6") || str.contains("F6") || str.contains("H5") || str.contains("H4") || str.contains("H3") || str.contains("I3")) {
                            transition.area_id = "H6";
                        } else {
                            String str2 = IUcMoQOkPHcA.HxbpqAm;
                            if (str.contains(str2)) {
                                transition.area_id = str2;
                            } else if (str.contains("H13") || str.contains(LpvdRIktEBw.NyIbPY) || str.contains("I12") || str.contains("H12")) {
    ...
    public static void h(Character character) {
        ...
        if (character.Z0(character.sheet.skillSet.f("holy_shield"), 0.5f)) {
            ...
            character.W0(i3);
            character.q1(CharacterResistances.ResistanceType.f3213e, i2, 12.0f);
    ...
    public static void l(Character character, String str, int i2, int i3) {
        if (Rules.i(str) == null) {
            ...
            Settings.C(1, "GL_spawnerror_" + str);
            return;
        }
        ...
        npc.tag = Integer.toHexString(FDUtils.b(1, 1000));
        npc.f3307x = character.f3307x;
        npc.f3308y = character.f3308y;
        GameLevel.a(npc);
        npc.B1();
        ...
        w0.a.l().a(new w(npc.q(), GameString.b("SUMMONED", false), 1.2f, Color.BLUE, 0.8f, 0.8f));
        w0.a aVarL = w0.a.l();
        a.EnumC0056a enumC0056a = a.EnumC0056a.f3897p;
        aVarL.getClass();
        aVarL.b(npc.B(), enumC0056a, 1.0f).owner = npc;
        GameAssets.o("spell1");
    }
    ...
    public static void m(Character character) {
        ...
        for (NPC npc : GameLevelData.t()) {
            if (!npc.destroy && npc.sheet.P("undead") && b.s(npc.B(), character.B()) <= 128 && GameWorld.f3410c.g(npc.r(), character.r())) {
                npc.z1(3);
            }
        }
        w0.a.l().d(1.0f, character.f3307x, character.f3308y, VertexAttributes.Usage.Tangent, jzidqMPaLNVH.RUPygma);
    }
