...
public class StatBonus {
    ...
    public static final class BonusType {
        ...
        private static final /* synthetic */ BonusType[] f3502b = {new BonusType("ADDITION", 0), new BonusType("MULTIPLIER", 1), new BonusType("ASSIGN", 2)};
