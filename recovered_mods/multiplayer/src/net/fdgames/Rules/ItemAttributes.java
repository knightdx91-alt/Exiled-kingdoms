...
public class ItemAttributes {
    ...
    public ItemAttributes(String str) {
        ...
        if (lowerCase.contains(jzidqMPaLNVH.ZAJTOCrWR)) {
            this.banishing = 3;
        }
        if (lowerCase.contains(vIBRkbZbNjpf.oVMMMyd)) {
            this.banishing = 4;
        }
        ...
        if (lowerCase.contains(RCsZWh.FiOChIteNpbdhf)) {
            this.beast_slayer = 3;
        }
        ...
        if (lowerCase.contains(rFUF.wFVNoCa)) {
            this.slow = 4;
        }
        ...
        if (lowerCase.contains(EGEEZWr.PPVpub)) {
            this.stun = 3;
        }
        if (lowerCase.contains("[stun,4]")) {
            this.stun = 4;
        }
        if (lowerCase.contains(lRWXeT.OUVqk)) {
            this.stun = 5;
        }
        ...
        if (lowerCase.contains(pgtXvpMCFu.kTmZtUH)) {
            this.paralysis = 5;
        }
        ...
        if (lowerCase.contains(pgtXvpMCFu.KWVNJ)) {
            this.wand = 1;
        }
        ...
        if (lowerCase.contains(RCsZWh.jCXWgtoHFCTJpG)) {
            this.vicious = 3;
        }
        if (lowerCase.contains("[detection,1]")) {
            this.detection = 1;
        }
        if (lowerCase.contains(yorS.cnWpRTWjiJEvzX)) {
            this.detection = 2;
        }
        ...
        if (lowerCase.contains(JNrsKSCxIEXndG.dOOmOO)) {
            this.blessed = 3;
        }
        ...
        if (lowerCase.contains(lxYOBQSyWPCj.IVvVUoCyJJFoML)) {
            this.shield = 1;
        }
        if (lowerCase.contains("[offhand]")) {
            this.offhand = 1;
        }
        if (lowerCase.contains(pgtXvpMCFu.SgwM)) {
            this.orb = 1;
        }
    }
}
