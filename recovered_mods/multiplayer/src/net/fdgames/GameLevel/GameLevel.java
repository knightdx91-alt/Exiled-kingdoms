...
public class GameLevel {
    ...
    public static AStarPathFinder f3309a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static boolean f3310b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static ArrayList<MapActor> f3311c = new ArrayList<>();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static ArrayList<MapSprite> f3312d = new ArrayList<>();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static double f3313e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public static int f3314f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static boolean f3315g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public static int f3316h;
    private boolean checkedDuplicatedIDs;
    private float initializationTime;

    public GameLevel(Transition transition) {
        this.initializationTime = 0.0f;
        l.e("GameLevel.InitializeLevel()");
        GameData.v().NewArea = null;
        f3309a = new AStarPathFinder();
        GameLevelData.B();
        Coords coordsT = b.P().t(transition);
        GameData.v().player.f3307x = coordsT.f3508x;
        GameData.v().player.f3308y = coordsT.f3509y;
        ...
        l.e("GameLevel.InitializeLevel() - done");
    }
    ...
    public static Projectile c(int i2, int i3, int[] iArr, WeaponStats weaponStats, DamageData damageData, Projectile.ProjectileType projectileType) {
        ...
        Projectile projectile = new Projectile(i2, mapActorG.f3307x, mapActorG.f3308y, iArr, weaponStats, damageData, projectileType);
    ...
    public static MapSprite i(int i2) {
        ArrayList<MapSprite> arrayList = f3312d;
        if (arrayList == null || arrayList.size() == 0) {
            f3312d = GameLevelData.x();
        }
        for (int i3 = 0; i3 < f3312d.size(); i3++) {
            if (f3312d.get(i3).q() == i2) {
                return f3312d.get(i3);
            }
        }
        return null;
    }
    ...
    public static boolean m() {
        return GameData.v().realTime > f3313e + 2.0d;
    }

    public static void n(boolean z2) {
        f3310b = z2;
        f3313e = GameData.v().realTime;
        if (f3310b) {
            return;
        }
        x0.b.i();
    ...
    public final void o(float f2) {
        if (z.A().booleanValue() || z.z().booleanValue()) {
            n(true);
        }
        if (!f3310b) {
            ArrayList<MapActor> arrayList = f3311c;
            arrayList.clear();
            f3312d.clear();
            ...
            GameData.v().Z(f2);
            MessageRouter.e();
            int size = f3312d.size();
            for (int i3 = 0; i3 < size; i3++) {
                f3312d.get(i3).visibleToPlayer = Boolean.FALSE;
                f3312d.get(i3).M(f2);
            }
