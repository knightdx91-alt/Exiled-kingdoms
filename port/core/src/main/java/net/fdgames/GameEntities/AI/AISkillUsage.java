...
public class AISkillUsage {
    ...
    public static void a(NPC npc) {
        ...
        if (npc.sheet.skillSet.k("heal_wounds") && FDUtils.b(1, 100) <= 45) {
    ...
    public static Character d(NPC npc) {
        ...
        for (NPC npc2 : GameLevelData.t()) {
            if (!npc2.i0() && npc2.f3092x - npc.f3092x < 224 && npc2.f3093y - npc.f3093y < 224 && !GameWorld.f3189c.g(npc.r(), npc2.r()) && npc2.sheet.r() > 0.5f) {
                return npc2;
            }
        }
        return null;
