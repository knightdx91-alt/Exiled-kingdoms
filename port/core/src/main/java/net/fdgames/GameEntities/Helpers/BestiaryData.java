...
public class BestiaryData {
    ...
    public static void a(NPC npc) {
        if (ExiledKingdoms.f3378h) {
            ...
            sb.append(f3045b.F(CharacterResistances.ResistanceType.Fire));
            sb.append(",");
            sb.append(f3045b.F(CharacterResistances.ResistanceType.Cold));
            sb.append(",");
            sb.append(f3045b.F(CharacterResistances.ResistanceType.Shock));
            sb.append(",");
            sb.append(f3045b.F(CharacterResistances.ResistanceType.Death));
            sb.append(",");
            sb.append(f3045b.F(CharacterResistances.ResistanceType.Toxic));
            sb.append(",");
            sb.append(f3045b.F(CharacterResistances.ResistanceType.Spirit));
            sb.append(" ; Movement: ");
