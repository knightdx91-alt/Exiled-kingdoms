...
public final class GameData {
    ...
    public final void P() {
        if (this.party.j()) {
            ...
            a.l().b(v().party.f().B(), a.EnumC0031a.LEVELUP, 0.0f);
    ...
    public final void Q() {
        ...
        this.times_reset++;
        a.l().b(this.player.B(), a.EnumC0031a.LEVELUP, 0.0f);
        GameAssets.o("levelup");
    }
                ...
                if (v().player.sheet.stats.f() >= 11) {
                    try {
                        ...
                        for (int i2 = 1; DynamicEvent.a(dynamicEvent2) && i2 < 100; i2++) {
                            ...
                            System.out.println("DynamicEvent.getNewValidEvent() attempts:" + i2);
                        }
    ...
    public final boolean e() {
        if (!this.blood && (this.gameVariables.b("blood1") != 1 || this.gameVariables.b("blood2") != 1 || this.gameVariables.b("blood3") != 1)) {
            return false;
        }
        this.blood = true;
        return true;
    ...
    public final String p() {
        ...
        if (this.difficulty == 0) {
            strO = a.a.n("DL_NORMAL", false, a.a.s(strO));
        }
        if (this.difficulty == 1) {
            strO = a.a.n("DL_HARD", false, a.a.s(strO));
        }
        if (this.difficulty == 2) {
            strO = a.a.n("DL_IRONMAN", false, a.a.s(strO));
        }
        if (this.difficulty == 3) {
            strO = a.a.n("DL_CASUAL", false, a.a.s(strO));
        }
        return this.difficulty == 4 ? a.a.n("DL_STORY", false, a.a.s(strO)) : strO;
    }
