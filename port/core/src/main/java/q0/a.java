...
public final class a extends Window implements r {
    ...
    final class b extends n0.j {
        ...
        protected final void result(Object obj) {
            ...
            com.badlogic.gdx.files.FileHandle aVar2 = Serializer.f3225b;
    ...
    final class d extends ChangeListener {
        ...
        public final void changed(ChangeListener.ChangeEvent changeEvent, Actor actor) {
            ...
            if (bytes == null || bytes.length < 100) {
                aVar.f(k.CLOUD_UPLOAD_ERROR, Quests.SELECT_COMPLETED_UNCLAIMED);
                return;
            }
    ...
    /* JADX INFO: compiled from: BackupWindow.java */
    public enum k {
        CLOUD_UPLOAD_OK, CLOUD_DOWNLOAD_OK, CLOUD_UPLOAD_ERROR, CLOUD_DOWNLOAD_ERROR;
    }

    public a(com.badlogic.gdx.Game eVar, z zVar) {
        super("", Assets.g());
    ...
    public final void h(k kVar, int i2, byte[] bArr, String str) {
        ...
        k kVar2 = k.CLOUD_DOWNLOAD_ERROR;
    ...
    public final void show(Stage stage) {
        ...
        com.badlogic.gdx.Game eVar = this.f3796l;
        if (z2) {
