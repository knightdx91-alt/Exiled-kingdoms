...
public final class h extends Window {
    ...
    public h() {
        ...
        g gVar = new g(g.a.UP);
        this.f3890d = gVar;
        g gVar2 = new g(g.a.DOWN);
        this.f3891e = gVar2;
        g gVar3 = new g(g.a.LEFT);
        this.f3892f = gVar3;
        g gVar4 = new g(g.a.RIGHT);
        this.f3893g = gVar4;
        g gVar5 = new g(g.a.ATTACK);
        this.f3894h = gVar5;
        g gVar6 = new g(g.a.CANCEL);
        this.f3895i = gVar6;
        g gVar7 = new g(g.a.s);
        this.f3896j = gVar7;
        g gVar8 = new g(g.a.DROP);
        this.f3897k = gVar8;
        g gVar9 = new g(g.a.SKILL1);
        this.f3898l = gVar9;
        g gVar10 = new g(g.a.SKILL2);
        this.f3899m = gVar10;
        g gVar11 = new g(g.a.SKILL3);
        this.f3900n = gVar11;
        g gVar12 = new g(g.a.SKILL4);
        this.f3901o = gVar12;
        g gVar13 = new g(g.a.SKILL5);
        this.f3902p = gVar13;
        g gVar14 = new g(g.a.SKILL6);
        this.f3903q = gVar14;
        g gVar15 = new g(g.a.SKILL7);
        this.f3904r = gVar15;
        g gVar16 = new g(g.a.SKILL8);
        this.s = gVar16;
        g gVar17 = new g(g.a.NEXTITEM);
        this.f3905t = gVar17;
        g gVar18 = new g(g.a.PREVITEM);
        this.f3906u = gVar18;
        g gVar19 = new g(g.a.USEITEM);
        this.f3907v = gVar19;
        g gVar20 = new g(g.a.RECOVERY);
        this.f3908w = gVar20;
        this.f3909z = null;
    ...
    public final void draw(Batch batch, float f2) {
        ...
        if (ExiledKingdoms.g()) {
            ...
            while (true) {
                ...
                ControllerCommand.commandType commandtype = ControllerCommand.commandType.POV;
        ...
        if (i2 != -999) {
            ...
            controllerCommand5.type = ControllerCommand.commandType.BUTTON;
        ...
        if (i3 == -999) {
            if (i4 != -999) {
                ...
                controllerCommand6.type = ControllerCommand.commandType.KEY;
        ...
        if (z2) {
            ...
            controllerCommand7.type = ControllerCommand.commandType.NEGATIVE_AXIS;
            controllerCommand7.id = i3;
        } else {
            ControllerCommand controllerCommand8 = this.f3909z;
            controllerCommand8.type = ControllerCommand.commandType.POSITIVE_AXIS;
