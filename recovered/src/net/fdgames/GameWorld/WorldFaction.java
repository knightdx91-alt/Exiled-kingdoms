...
public class WorldFaction {
    ...
    public static String d(int i2) {
        ...
        return i2 <= -80 ? GameString.b("ARCH-ENEMY", false) : i2 <= -60 ? GameString.b("ENEMY", false) : i2 <= -40 ? GameString.b("CRIMINAL", false) : i2 <= -20 ? GameString.b("BANDIT", false) : i2 <= -5 ? GameString.b("RASCAL", false) : i2 <= 9 ? GameString.b("UNKNOWN", false) : i2 <= 24 ? GameString.b("FRIENDLY", false) : i2 <= 39 ? GameString.b("TRUSTED", false) : i2 <= 59 ? GameString.b("HERO", false) : i2 <= 79 ? GameString.b("GREAT_HERO", false) : i2 <= 100 ? GameString.b("LEGENDARY_HERO", false) : "";
    }
